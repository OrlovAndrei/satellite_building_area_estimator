...
Разметка выполнялась совместно несколькими участниками.

**Stepik ID: 597996051, 644912393, 210911504, 1124051397.**

Снимки были распределены пропорционально вкладу участника.

Разметка осуществлялась с использованием [CVAT](https://www.cvat.ai/)

![alt text](images/cvat.png)

Скачать размеченные снимки можно по [ссылке](https://drive.google.com/file/d/16W0-MQ0qsoyl8hq4fnfGoFDay30vif35/view?usp=sharing).

Метрики модели сегментайции на тестовой выборке:
